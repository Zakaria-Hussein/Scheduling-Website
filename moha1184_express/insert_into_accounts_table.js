...
dbCon.connect(function (err) {
    ...
    const rowToBeInserted = {
        acc_name: 'moha1184',            // replace with acc_name chosen by you OR retain the same value
        acc_login: 'moha1184',           // replace with acc_login chosen by you OR retain the same value
